...
CUSTOM_MIDDLE_PMP = str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "**Ciao`"
USER_BOT_WARN_ZERO = "`Stai spammando, sei stato bloccato.` "
USER_BOT_NO_WARN = ("`Ciao, sei nella mia gui**\n"  
                    "**Dirò al mio capo**\n"
                    f"{DEFAULTUSER} di risponderti appena può ! Ora per aiutarlo !\n\n"
                    f"{CUSTOM_MIDDLE_PMP} \n\n"
                    "**Scrivi** 🍁 `/start` 🍁  **Per aiutare il mio Capo!!**")
